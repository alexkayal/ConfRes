...
function storeSliderValues(){
    ...
    setCookie("sliderPage1_slider1", slider1Value, expiryDays);
    setCookie("sliderPage1_slider2", slider2Value, expiryDays);
    setCookie("sliderPage1_slider3", slider3Value, expiryDays);
    setCookie("sliderPage1_slider4", slider4Value, expiryDays);
    setCookie("sliderPage1_slider5", slider5Value, expiryDays);
}

function storeRadioValues(){
    for (var i = 1; i<=5; i++){
        var radioButtonValue = $("input[name='radioButton"+i+"']:checked").val();
        setCookie("sliderPage1_RadioButton"+i, radioButtonValue, expiryDays);
    }
}