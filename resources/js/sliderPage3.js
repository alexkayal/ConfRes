...
function storeSliderValues(){
    ...
    setCookie("sliderPage3_slider1", slider1Value, expiryDays);
    setCookie("sliderPage3_slider2", slider2Value, expiryDays);
    setCookie("sliderPage3_slider3", slider3Value, expiryDays);
    setCookie("sliderPage3_slider4", slider4Value, expiryDays);
    setCookie("sliderPage3_slider5", slider5Value, expiryDays);
}
...
function storeRadioValues(){
    for (var i = 1; i<=5; i++){
        ...
        setCookie("sliderPage3_RadioButton"+i, radioButtonValue, expiryDays);
    }
}